...
> = {
  Mastercard: {
    ...
    cancelled_card: { number: '5597251149584267', cvv: '340', expirationDate },
  ...
  Visa: {
    ...
    cancelled_card: { number: '4485406132091427', cvv: '170', expirationDate },
  ...
  Amex: {
    ...
    cancelled_card: { number: '342582504975297', cvv: '6820', expirationDate },
  ...
  HiperCard: {
    ...
    cancelled_card: { number: '6062824159779557', cvv: '480', expirationDate },
  ...
  DinersClub: {
    ...
    cancelled_card: { number: '36176932295997', cvv: '660', expirationDate },
